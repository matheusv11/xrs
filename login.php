...
<html lang="pt-br">
  ...
  <body>
    ...
    <header>
      <nav class="custom navbar navbar-expand-lg navbar-dark bg-dark navbarCustom">
  ...
  <main role="main" class="container fluid">
    ...
    <div class="container fluid doacao space">
      ...
      <label class="labelDoar"> LOGIN:</label>
          ...
          <div class="col">
            <input type="text" class="form-control inputLogin" placeholder="email" name="email" required> <br>
						<input type="password" class="form-control inputLogin" placeholder="senha" name="senha" required>
          </div>
				...
				<div class="col">
					<div class="form-group form-check">
						<br>
						<button type="submit" class="btn btn-success botaoDoar"> ENTRAR </button>
					</div>
				</div>
